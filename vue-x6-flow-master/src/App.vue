  ...
  methods: {
    ...
    initGraph() {
      ...
      Graph.registerNode(
        'dag-condition',
        {
          // 指定节点的shape为vue-shape，并通过component属性来指定渲染节点的 Vue 组件。
          inherit: 'vue-shape',
          width: 180,
          height: 36,
          component: {
